...
metadata:
  ...
  uuid: 11ty/import::wordpress::https://flohgro.com/web/?p=275
  type: wordpress
  url: >-
    https://flohgro.com/drafts-actions/prepend-draft-to-craft-note-as-todo-item-with-due-date/
tags:
  - drafts-actions
  - craft
---
This action prepends the content of the current draft as todo item with due date to a selectable document in one of your Craft spaces.
...
➡️ [GET THE ACTION](https://directory.getdrafts.com/a/1vH)