...
metadata:
  ...
  uuid: 11ty/import::wordpress::https://flohgro.com/web/?p=273
  type: wordpress
  url: >-
    https://flohgro.com/drafts-actions/append-draft-to-craft-note-as-todo-item-with-due-date/
tags:
  - drafts-actions
  - craft
---
This action appends the content of the current draft as todo item with due date to a selectable document in one of your Craft spaces.
...
➡️ [GET THE ACTION](https://directory.getdrafts.com/a/1vI)